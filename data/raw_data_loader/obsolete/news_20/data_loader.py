...
class ClientDataLoader(BaseClientDataLoader):
    ...
    def __init__(self, data_path, partition_path, client_idx=None, partition_method="uniform", tokenize=False, clients_num=100):
        data_fields = ["X", "Y"]
        super().__init__(data_path, partition_path, client_idx, partition_method, tokenize, data_fields, clients_num)
        self.clean_data()
        if self.tokenize:
            self.tokenize_data()
