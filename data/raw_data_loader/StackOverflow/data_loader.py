...
# temp
import sys
sys.path.insert(0, os.path.abspath(os.path.join(os.getcwd(), "../../../data_preprocessing/")))
...
class RawDataLoader(LanguageModelRawDataLoader):
    ...
    def generate_partial_h5_file(group_id):
        ...
        end = len(global_X) if (group_id + 1) * CHUNK_SIZE > len(global_X) else (group_id + 1) * CHUNK_SIZE
